...
public interface AlertaAPI {
    ...
    public class Factory {
        ...
        public static AlertaAPI getInstance() throws KeyManagementException, NoSuchAlgorithmException {
    ...
    @GET("com.mim.alerta/api/{name}")
    public Call<ResponseBody> audio(@Path("name") String id);
